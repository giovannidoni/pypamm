...
def main():
    ...
    parser.add_argument('--config', default='complex',
                        help='Configuration name or path to YAML file (default: complex)')
    parser.add_argument('--output', '-o', default='pipeline_example.png',
                        help='Output file path for the visualization')
    parser.add_argument('--ngrid', type=int, default=30,
                        help='Number of grid points for grid selection (default: 30)')
    parser.add_argument('--k', type=int, default=5,
                        help='Number of neighbors for neighbor graph (default: 5)')
    parser.add_argument('--lambda-qs', type=float, default=1.0,
                        help='Lambda parameter for Quick Shift (default: 1.0)')
    parser.add_argument('--max-dist', type=float, default=3.0,
                        help='Maximum distance for Quick Shift (default: 3.0)')
