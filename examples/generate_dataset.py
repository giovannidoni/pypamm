...
from data_generator import generate_dataset, load_config, list_available_configs
...
def main():
    ...
    parser.add_argument('--output', '-o', default=None,
                        help='Output file path for the generated dataset (numpy .npy format)')
    parser.add_argument('--visualize', '-v', action='store_true',
                        help='Visualize the generated dataset')
    parser.add_argument('--save-plot', '-p', default=None,
                        help='Save the visualization to the specified file')
