...
from pypamm import build_knn_graph, build_neighbor_graph
...
def main():
    ...
    parser.add_argument(
        "--config", default="clustered", help="Configuration name or path to YAML file (default: clustered)"
    )
    parser.add_argument(
        "--output", "-o", default="neighbor_graph_example.png", help="Output file path for the visualization"
    )
    parser.add_argument("--k", type=int, default=5, help="Number of neighbors for KNN graph (default: 5)")
