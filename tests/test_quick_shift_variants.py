...
def test_max_dist_parameter(random_data):
    ...
    labels_small_dist, centers_small_dist = quick_shift(
        random_data, None, ngrid=10, max_dist=0.1
    )
    
    # Run vanilla QuickShift with a large max_dist
    labels_large_dist, centers_large_dist = quick_shift(
        random_data, None, ngrid=10, max_dist=2.0
    )
    ...
    labels_kde_small, centers_kde_small = quick_shift_kde(
        random_data, bandwidth=0.1, ngrid=10, max_dist=0.1
    )
    
    labels_kde_large, centers_kde_large = quick_shift_kde(
        random_data, bandwidth=0.1, ngrid=10, max_dist=2.0
    )
...
def test_lambda_parameter(random_data):
    ...
    labels_small_lambda, centers_small_lambda = quick_shift(
        random_data, None, ngrid=10, lambda_qs=0.5
    )
    
    labels_large_lambda, centers_large_lambda = quick_shift(
        random_data, None, ngrid=10, lambda_qs=2.0
    )
